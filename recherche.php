...
<body>
    <div class="col-6">
        <div class="d-flex justify-content-between mt-2 w-100">
            ...
            $sql = "SELECT users.name,username,message,avatar,date_send,tweet.id as lid,id_reply_tweet,id_user,id_retweet FROM tweet left join users on tweet.id_user=users.id where tweet.message like '%$recherche%' or users.username like '%$recherche%' or users.name like '%$recherche%'   AND id_reply_tweet is null order by date_send desc";
            $query = $conn->prepare($sql);
            $query->execute();
            $result = $query->fetchAll();
            // --------------------------------------------------------------------
            $query = "SELECT users.name,username,message,avatar,date_send,tweet.id as lid,id_reply_tweet,id_user,id_retweet FROM tweet left join users on tweet.id_user=users.id where tweet.message like '%$recherche%' or users.username like '%$recherche%' or users.name like '%$recherche%'   AND id_reply_tweet is null order by date_send desc";
                ...
                foreach ($result as $key => $value) {
                    ...
                    if ($value['id_retweet'] != '') {
                        ...
                        <div class="champtweet">
                            <div class="row">
                                <div class="col-1">
                                    <a href="profil.php?id_profil=<?= $resultat['id_user'] ?>"><img
                                            class="rounded-circle bg-light mt-1" src=<?= $resultat['avatar'] ?> alt=""
                                ...
                                <div class="col-10">
                                    ...
                                    <div class="inter">
                                        ...
                                        if ($isrt['test'] == 0) {
                                            ?>
                                            <form method="post" action="redirection.php?id_tweet=<?= $nbrlike ?>&url=accueil.php">
                                        ...
                                        <?php } else { ?>
                                            <form method="post" action="redirection.php?id_tweet=<?= $nbrlike ?>&url=accueil.php">
                                                <button type="submit" name="unretweetrt"><i id="undeathtwett"
                                        ...
                                        if ($islike['test'] == 0) {
                                            ?>
                                            <form method="post" action="redirection.php?id_tweet=<?= $id ?>&url=accueil.php">
                    ...
                    // Else ou le tweet n'est pas un retweet
                        ...
                        <div class="champtweet">
                            <div class="row">
                                <div class="col-1">
                                    <a href="profil.php?id_profil=<?= $value['id_user'] ?>"><img
                                            class="rounded-circle bg-light mt-1" src=<?= $value['avatar'] ?> alt="" width="50px"
                                            height="50px"></a>
                                </div>
                                <div class="col-10">
                                    <div class="d-flex">
                                    ...
                                    <div class="inter">
                                        ...
                                        // --------------------------------------------------------------------
                                        ?>
                                        <a href="reponses.php?id_tweet=<?= $nbrlike ?>"><i id="comment"
                                        ...
                                        if ($islike['test'] == 0) {
                                            ?>
                                            <form method="post"
                                                action="redirection.php?id_tweet=<?= $value['lid'] ?>&url=accueil.php">
                                                <button type="submit" name="retweet"><i id="deathtwett" class="fa-solid fa-skull">
                                                        <?= $resultat['test'] ?>
                                                    </i></button>
                                            </form>
                                        <?php } else { ?>
                                            <form method="post"
                                                action="redirection.php?id_tweet=<?= $value['lid'] ?>&url=accueil.php">
                                                <button type="submit" name="unretweet"><i id="undeathtwett"
                                                        class="fa-solid fa-skull">
                                                        <?= $resultat['test'] ?>
                                                    </i></button>
                                            </form>
