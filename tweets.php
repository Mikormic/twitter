            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    <div class="inter">
                        ...
                        // --------------------------------------------------------------------
                        ?>
                        <a href="reponses.php?id_tweet=<?= $id ?>"><i id="comment" class="fa-regular fa-comment"><?= $resultat['test'] ?></i></a>   
            ...
            <div class="row">
                ...
                <div class="col-10">
                    ...
                    // Requete pour savoir combien de reponses a chaque tweet et l'afficher a coté de l'icone tete de mort
                        ...
                        if ($islike['test'] == 0) {
                            ?>
                            <form method="post" action="redirection.php?id_tweet=<?= $value['lid'] ?>&url=accueil.php?page=8">
                                <button type="submit" name="retweet"><i id="deathtwett" class="fa-solid fa-skull">
                                        <?= $resultat['test'] ?>
                                    </i></button>
                            </form>
